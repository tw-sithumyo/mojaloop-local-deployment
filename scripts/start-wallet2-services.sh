...
start_service_with_port wallet2-web-inbound "$WEB_INBOUND_PORT" start:apps-web-inbound '(apps-web-inbound|dist/packages/apps/web-inbound/main)'
start_service_with_port wallet2-web-outbound "$WEB_OUTBOUND_PORT" start:apps-web-outbound '(apps-web-outbound|dist/packages/apps/web-outbound/main)'
