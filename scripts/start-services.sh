...
start_service quoting-api quoting-service 3002 env QUOTE_PROXY_CACHE__enabled=false QUOTE_PAYLOAD_CACHE__enabled=false npm run start:api
start_service quoting-handlers quoting-service 3103 env QUOTE_PROXY_CACHE__enabled=false QUOTE_PAYLOAD_CACHE__enabled=false QUOTE_MONITORING_PORT=3103 npm run start:handlers
