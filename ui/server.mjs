...
const serviceDefinitions = [
    ...
    {
        id: 'mtpa-web-outbound',
        name: 'MTPA Web Outbound',
        group: 'wallet',
    ...
    },
    {
        ...
        name: 'Wallet1 Connector',
        group: 'wallet',
        pidFiles: ['wallet1-connector.pid'],
        logFiles: ['wallet1-connector.log'],
    },
    {
        id: 'wallet2-connector',
        name: 'Wallet2 Connector',
        group: 'wallet',
        pidFiles: ['wallet2-connector.pid'],
        logFiles: ['wallet2-connector.log'],
    },
];
