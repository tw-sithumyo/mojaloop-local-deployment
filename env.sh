...
JAVA_HOME="$ROOT_DIR/tools/jdk-21.0.10+7"
if [ ! -d "$JAVA_HOME" ]; then
...
export ROOT_DIR RUNTIME_ROOT NODE_HOME JAVA_HOME KAFKA_HOME MAVEN_HOME LOCAL_HOME DATA_DIR LOG_DIR RUN_DIR CONF_DIR
