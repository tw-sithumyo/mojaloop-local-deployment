...
export ROOT_DIR PIVOTAL_HOME PIVOTAL_CONNECTOR_HOME DEMOWALLET_HOME RUNTIME_ROOT NODE_HOME JDK11_HOME JDK_HOME JAVA_HOME DEMOWALLET_JAVA_HOME MAVEN_HOME KAFKA_HOME LOCAL_HOME DATA_DIR LOG_DIR RUN_DIR CONF_DIR
